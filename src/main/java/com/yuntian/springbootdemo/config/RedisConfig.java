package com.yuntian.springbootdemo.config;
...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public RedisTemplate<String, ?> setRedisTemplate(int redisDb) {
        ...
        om.setVisibility(PropertyAccessor.ALL, JsonAutoDetect.Visibility
                .ANY);
     ...
     */
    @Bean
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) { // 设置缓存有效期一小时
        RedisCacheConfiguration redisCacheConfiguration = RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofHours(1)); // 开启使用缓存名称最为key前缀
